...
int IntMatrixCalculator::multiply(long addressMatrixA, long byteSizeMatrixA, long addressMatrixB, long byteSizeMatrixB, long addressMatrixResult) {
    MPI_Init(NULL, NULL);

    std::cout << "matrix A address=" << addressMatrixA;
    std::cout << "\n";
    std::cout << "matrix A byteSize=" << byteSizeMatrixA;
    std::cout << "\n";

    std::cout << "matrix B address=" << addressMatrixB;
    std::cout << "\n";
    std::cout << "matrix B byteSize=" << byteSizeMatrixB;
    std::cout << "\n";

    std::cout << "matrix Result address=" << addressMatrixResult;
    std::cout << "\n";
    ...
    int AR = 4; // Number of rows in matrix A
    int AC = 5; // Number of columns in matrix A

    int BR = AC; // Number of rows in matrix B (= Number of columns in matrix A)
    int BC = 6; // Number of columns in matrix B
...
int intMatrixCalculatorMultiply(IntMatrixCalculator *ptr, long addressMatrixA, long byteSizeMatrixA, long addressMatrixB, long byteSizeMatrixB, long addressMatrixResult) {
    return ptr->multiply(addressMatrixA, byteSizeMatrixA, addressMatrixB, byteSizeMatrixB, addressMatrixResult);
}
